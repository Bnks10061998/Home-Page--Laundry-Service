...
//                       Starting at <span className="font-bold text-green-600">₹199</span>
//                     </p>
//                   </div>
...
//                       Use code: <span className="font-mono text-blue-700">WELCOME10</span>
//                     </p>
//                   </div>
...
//             ].map((review, idx) => (
//               <div key={idx} className="bg-gray-100 rounded-lg p-4 mb-4">
...
//                   Clothes returned fresh, clean, and neatly folded. Highly recommend!
//                 </p>
//               </div>
//             ))}
//           </motion.div>
